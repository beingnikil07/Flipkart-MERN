...
const ActionItem = ({ product }) => {
    ...
    const buyNow = async () => {
        let response = await PayWithPaytm({ amount: 500, email: 'kumarnikil220@gmail.com' });
        let information = {
    ...
    return (
        <LeftContainer>
            ...
            <StyledBtn variant="contained" onClick={() => buyNow()} style={{ marginLeft: 10, background: '#ff9f00' }}><Flash />Buy Now</StyledBtn>
        </LeftContainer>
    )
}
